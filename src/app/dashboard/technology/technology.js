...
.controller( 'DashboardTechnologyCtrl', function DashboardTechnologyController( $scope, $filter, $stateParams, Restangular, countryCode, apis, agentStatistics) {
    ...
    technology.map = {
        regions: [{
            ...
            minColor: '#49c5b1',
            maxColor: '#F90101',
            data: technology.worldMap.map(function(d){
                return {
