    ...
    function settings() {
        return {
            "statuses": [
                ...
                { id: 300, group: "Redirection", label: 300, code: 300, description: "multiple options for the resource delivered" },
                { id: 301, group: "Redirection", label: 301, code: 301, description: "this and all future requests directed to the given URI" },
            ...
            "contentTypes": [
                ...
                { id: 1, group: "Application", label: "application/hal+json" },
                { id: 2, group: "Application", label: "application/x-www-form-urlencoded" },
                { id: 3, group: "Application", label: "application/xhtml+xml" },
                { id: 4, group: "Application", label: "application/xml" },
                { id: 100, group: "Audio", label: "audio/mpeg" },
                { id: 101, group: "Audio", label: "audio/ogg" },
                { id: 200, group: "Image", label: "image/gif" },
                { id: 2001, group: "Image", label: "image/jpeg" },
                { id: 202, group: "Image", label: "image/png" },
                { id: 203, group: "Image", label: "image/svg+xml" },
                { id: 300, group: "Message", label: "message/http" },
                { id: 301, group: "Message", label: "message/partial" },
                { id: 400, group: "Model", label: "model/vrml" },
                { id: 500, group: "Multipart", label: "multipart/form-data" },
                { id: 600, group: "Text", label: "text/css" },
                { id: 601, group: "Text", label: "text/csv" },
                { id: 602, group: "Text", label: "text/html" },
                { id: 603, group: "Text", label: "text/json" },
                { id: 604, group: "Text", label: "text/plain" },
                { id: 605, group: "Text", label: "text/xml" },
                { id: 700, group: "Video", label: "video/mpeg" },
                { id: 701, group: "Video", label: "video/mp4" },
                { id: 702, group: "Video", label: "video/x-flv" }
            ]
        };
    }
    return {
